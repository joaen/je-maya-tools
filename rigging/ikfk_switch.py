...
class TemplateToolWindow(QtWidgets.QDialog):
    ...
    def create_ui_widgets(self):
        ...
        self.template_icon_button.setStyleSheet("background-color: #444444; border: 1px solid #444444;")
        ...
        self.help_icon_button.setStyleSheet("background-color: #444444; border: 1px solid #444444;")

         # setting background color to push button when mouse hover over it
        self.template_icon_button.setStyleSheet("QPushButton {"
        ...
        self.help_icon_button.setStyleSheet("QPushButton {"
                            "background-color: #444444;"
                            "border: 1px solid #444444;"
                            "border-radius: 12px;"
                            "}"
    ...
    def create_ui_connections(self):
        self.template_button1.clicked.connect(self.template_command)
